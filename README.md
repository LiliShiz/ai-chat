...
| `npm test` | Юнит-тесты сервера и фронта (61 штука) |
...
61 тест, Vitest. Они покрывают не «рендерится без падения», а то,
...
**Фронт (31).** Чтение потока: сборка текста из кусков, не совпадающих
